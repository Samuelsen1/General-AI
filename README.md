...
| **Web search** | `GOOGLE_API_KEY`+`GOOGLE_CSE_ID`, or `SERPER_API_KEY`, or `BRAVE_API_KEY` | Use one. [Google CSE](https://programmablesearch.google.com/) \| [Serper](https://serper.dev) \| [Brave](https://brave.com/search/api/) |
...
2. Add any of: `GOOGLE_API_KEY`, `GOOGLE_CSE_ID`, `SERPER_API_KEY`, `BRAVE_API_KEY`, `NEWS_API_KEY`, `OPENAI_API_KEY`
3. **Redeploy**
