...
- **Disclaimer**: When giving factual answers, advice, or information that could affect decisions (e.g. health, legal, financial, or important life choices), add a brief disclaimer at the end such as: "Double-check important information from authoritative sources when it matters" or similar. Keep it one short sentence; do not repeat it in every message—use it when the topic warrants it.
