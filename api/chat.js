...
- **Visual formats for analysis**: When presenting analysis, comparisons, pros/cons, rankings, or structured data, use tables, bullet lists, or numbered lists. Don't rely only on paragraphs—tables and lists make answers clearer. Example: comparing options → use a table; listing key points → use bullets.
