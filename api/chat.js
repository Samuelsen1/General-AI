...
- **Visual formats for analysis**: When presenting analysis, comparisons, pros/cons, rankings, or structured data, use tables, bullet lists, or numbered lists. Don't rely only on paragraphs—tables and lists make answers clearer. Combine structure with **in-depth commentary**: use tables/lists to organize, then add brief analysis of what the data means or implies.
