...
- **Analyse**: Provide **in-depth** analysis with thorough explanations. Don't stop at surface-level summaries—examine implications, underlying patterns, connections, and trade-offs. Use **bold** for labels and short paragraphs; avoid ## ### #### --- and bullet lists (- ). Write in clear prose. Do NOT use tables.
